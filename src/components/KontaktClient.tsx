...
export default function KontaktClient({
  ...
  const departments = [
    ...
    { key: "B2G", label: "B2G — Sektor rządowy", email: emailB2G },
    { key: "HANDEL", label: "HANDEL — Sprzedaż", email: emailHandel },
    { key: "BIURO", label: "BIURO — Informacje ogólne", email: emailBiuro },
  ];
                  ...
                  <div>
                    ...
                    <div className="flex gap-3">
                      <a href={facebookUrl} target="_blank" rel="noopener noreferrer"
                        className="group w-10 h-10 border border-accent/30 flex items-center justify-center text-accent hover:text-white hover:border-accent transition-all duration-300 relative overflow-hidden" aria-label="Facebook">
                      ...
                      <a href={instagramUrl} target="_blank" rel="noopener noreferrer"
                        className="group w-10 h-10 border border-accent/30 flex items-center justify-center text-accent hover:text-white hover:border-accent transition-all duration-300 relative overflow-hidden" aria-label="Instagram">
                        <div className="absolute inset-0 bg-accent/5 scale-0 group-hover:scale-100 transition-transform duration-300 origin-center" />
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="relative z-[1]">
                      ...
                      <a href={linkedinUrl} target="_blank" rel="noopener noreferrer"
                        className="group w-10 h-10 border border-accent/30 flex items-center justify-center text-accent hover:text-white hover:border-accent transition-all duration-300 relative overflow-hidden" aria-label="LinkedIn">
                        <div className="absolute inset-0 bg-accent/5 scale-0 group-hover:scale-100 transition-transform duration-300 origin-center" />
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="relative z-[1]">
                      ...
                      <a href={`mailto:${emailBiuro}`}
                        className="group w-10 h-10 border border-accent/30 flex items-center justify-center text-accent hover:text-white hover:border-accent transition-all duration-300 relative overflow-hidden" aria-label="Email">
                        <div className="absolute inset-0 bg-accent/5 scale-0 group-hover:scale-100 transition-transform duration-300 origin-center" />
                  ...
                  {submitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          <span className="font-[var(--font-mono)] text-[13px] text-accent/50 shrink-0">&gt;</span>
                          <button type="button" onClick={() => fileInputRef.current?.click()} className="font-[var(--font-mono)] text-[13px] text-accent/50 hover:text-accent transition-colors duration-200 flex items-center gap-2">
                            ...
                            ZAŁĄCZ PLIKI
                            {files.length > 0 && <span className="text-accent">[ {files.length} plik{files.length > 1 ? "i" : ""} ]</span>}
                          </button>
                          <input ref={fileInputRef} type="file" multiple accept=".pdf,.doc,.docx,.jpg,.jpeg,.png,.zip,.txt" onChange={handleFiles} className="hidden" />
                        </div>
                        {files.length > 0 && (
