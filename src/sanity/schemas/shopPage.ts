  ...
  fields: [
    ...
    defineField({
      ...
      of: [
        ...
        defineArrayMember({ type: 'shopFaqBlock', title: 'FAQ' }),
        defineArrayMember({ type: 'shopStatsBlock', title: 'Liczby / Statystyki' }),
        defineArrayMember({ type: 'shopBrandsBlock', title: 'Marki / Producenci' }),
        defineArrayMember({ type: 'shopRichTextBlock', title: 'Blok tekstu' }),
        defineArrayMember({ type: 'shopAlertBlock', title: 'Komunikat / Ogłoszenie' }),
      ],
    }),
  ],
  preview: {
