...
- 2026-09-22 · `.github/workflows/ci.yml` stworzony: npm ci, tsc --noEmit, npm run lint, gitleaks binary 8.18.4 (bez akcji, bez licencji). `.gitleaks.toml` z path-allowlistem na 004_xml_import_fields.sql.
