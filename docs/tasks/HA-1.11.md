...
- 2026-09-22 tj: review — odesłane raz (obejście przez chciwy regex heredoca + brak dowodów na żywo), po poprawce przyjęte; PR #10; udowodnione: 185/185 testów, psql localhost block/allow wg SUPABASE_TARGET, prod host block przy zmiennej, commit z „revoke grant" przechodzi; otwarte: oznaczenie wpisu HA-1.03 w deferred po merge'u #9 i #10
