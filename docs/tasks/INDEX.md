...
| HA-2.11 | Spechurt — podgląd i walidacja na aktualnym feedzie z serwera | todo | S | HA-2.04 | — | — |
| HA-2.12 | Kategoryzacja Kolby — reguły do drzewa Hydry | todo | L | HA-2.04 | — | — |
| HA-2.13 | hydra-categories.json do repo i weryfikacja z BaseLinkerem | in_progress | S | — | — | — |
