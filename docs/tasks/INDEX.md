...
| HA-1.06 | Lokalny stack Supabase z seedem; testy na lokalnej bazie | todo | L | HA-1.01, HA-1.05, HA-1.11 | — | — |
...
| HA-1.11 | Hook agenta — wyjątek dla lokalnej bazy i fałszywy alarm na treści commitów | in_progress | M | — | — | — |
