...
- Name: shop/product-detail.spec.ts >> /sklep/[id] — product detail page >> detail page shows price
- Location: tests/shop/product-detail.spec.ts:38:7
...
Call log:
  - navigating to "http://localhost:3001/sklep/619638287", waiting until "domcontentloaded"
